...
public class WallpaperActivity extends BaseLiveWallpaperService {
	...
	private ITextureRegion catRegion;
	private BitmapTextureAtlas catAtlas;
	...
	public void onCreateResources(
		...
		palmAtlas.load();
		catAtlas = new BitmapTextureAtlas(this.getTextureManager(), 240, 320);
		catRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(catAtlas,this.getAssets(), "gfx/cat.png", 0, 0);
		catAtlas.load();
	...
	public void onCreateScene(OnCreateSceneCallback pOnCreateSceneCallback)
		...
		autoParallaxBackground.attachParallaxEntity(new ParallaxEntity(-5.0f, new Sprite(0, 0, CAMERA_WIDTH, CAMERA_HEIGHT,  this.catRegion, vertexBufferObjectManager)));
